...
用户通过可授权的 AI 协作护照表达当前状态、能力证据和团队需求；系统解释谁值得认识。主动卡对卡碰触可以建立真实相遇连接，被动 NFC／二维码作为跨手机生态的兼容入口。关系建立后进入 `RALLY Room｜项目启动舱`，由 Agent 提出首次分工、人类认领并确认，再把日常执行交给飞书、GitHub 等已有工具。
...
- `http://localhost:4173/?variant=A&workspace=1`（预置项目启动舱）
...
- 产品阶段：96 小时黑客松 MVP；
- 手机端是现场主入口与项目伴随端，宽屏是 RALLY Room 主工作台，AI Passport 是可选现场终端；
