...
仅在主办方为特殊展会空间开启时存在、由已明确授权的参展成员组成的临时名册。它不是 RALLY 的常驻全局通讯录，也不等同于附近的人。
...
**RALLY Room／项目启动舱（Launch Room）**：
围绕一个明确项目组织成员、首次分工、必要权限、关键变更与贡献记录的临时治理边界。日常沟通、文档和代码执行进入已有工具。
