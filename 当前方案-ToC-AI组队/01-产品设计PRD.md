...
| 0.3 | 2026-08-29 | 冻结产品品牌 COSPAN｜共域；协作护照保留为身份能力，不再作为产品名称 |
| 0.4 | 2026-08-29 | 手机端、真实定位与协作后端进入可运行状态；发现页新增由用户控制的跨推荐／附近／名册硬门槛，不展示匹配百分比且不静默放宽 |
| 0.5 | 2026-08-30 | 曾评估“合拍”作为中文名，未作为最终品牌冻结 |
| 0.6 | 2026-08-30 | 中文品牌重新确认为“共域”，恢复人与 Agent 共创 Slogan，并统一文档、PWA 与 Android 对外名称 |
...
我们拟构建面向黑客松参与者的实时组队与协作产品 **COSPAN｜共域**。用户在活动前或现场主动授权展示自己的组队状态、能力标签、项目证据、兴趣方向和团队需求；系统匹配互补的人、项目和团队缺口，并解释“为什么值得聊”。两个已经面对面交流的人可主动碰触各自绑定账户的 AI Passport，碰触本身作为双方物理授权，直接建立“真实相遇连接”并生成相互介绍；单方面读取被动 NFC 或二维码时，只能打开有限资料并发起待确认请求。
