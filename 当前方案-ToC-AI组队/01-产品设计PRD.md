...
| 0.5 | 2026-08-30 | 中文品牌由“共域”更新为“合拍”；英文 COSPAN、协作护照与 COSPAN Space 能力命名保持不变 |
...
我们拟构建面向黑客松参与者的实时组队与协作产品 **COSPAN｜合拍**。用户在活动前或现场主动授权展示自己的组队状态、能力标签、项目证据、兴趣方向和团队需求；系统匹配互补的人、项目和团队缺口，并解释“为什么值得聊”。两个已经面对面交流的人可主动碰触各自绑定账户的 AI Passport，碰触本身作为双方物理授权，直接建立“真实相遇连接”并生成相互介绍；单方面读取被动 NFC 或二维码时，只能打开有限资料并发起待确认请求。
